...
public class notas_colegio {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        do {
            System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=");
			System.out.println("Sistema de controle de notas do Colégio Exemplo");
            System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
			Thread.sleep(600);
    ...
    private static double solicitaNota(String avaliacao){
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("A nota deve que ser um número.");
    ...
    private static void consultNotasTurma() throws InterruptedException {
        if (indiceAluno != 0) {
        	...
        	Thread.sleep(100);
            System.out.println("============================");
            System.out.println("Não existe registro de aluno!");
            System.out.println("============================\n");
            Thread.sleep(100);
        }
    }
