...
public class CalculadoraApp {
	...
	protected StringBuffer num1;
	protected StringBuffer num2;
	...
	private void initialize() {
		...
		frmCalculator.setForeground(SystemColor.windowBorder);
		frmCalculator.setFont(new Font("Calibri", Font.PLAIN, 15));
		frmCalculator.setResizable(false);
		frmCalculator.setTitle("Calculadora Java");
		frmCalculator.setType(Type.UTILITY);
		frmCalculator.setBounds(100, 100, 450, 300);
		frmCalculator.setSize(315, 430);
		...
		display.setText("0");
		display.setFont(new Font("Calibri", Font.PLAIN, 28));
		display.setHorizontalAlignment(SwingConstants.RIGHT);
		display.setBounds(6, 9, 280, 69);
